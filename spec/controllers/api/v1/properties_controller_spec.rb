...
RSpec.describe Api::V1::PropertiesController, type: :controller do
	...
	describe "#index", :vcr, record: :new_episodes do
		it "As a Requestor, When I access the list Then I should get back a list of requests for the current day by default And the list should be paginated with 50 per page", :vcr do
	...
	describe "#show", :vcr, record: :new_episodes do
	...
	describe "#create", :vcr, record: :new_episodes do
		...
		it "As a Requestor When I send an invalid address to process Then the response status code should be 406 (Not Acceptable) And the response error should be Invalid Address" do
			...
			response_data = JSON.parse(response.body)
			response_data["status"].should == "508"
		end
	...
	describe "#update", :vcr, record: :new_episodes do
	...
	describe "#destroy", :vcr, record: :new_episodes do
	...
	describe "#service_stats", :vcr, record: :new_episodes do
